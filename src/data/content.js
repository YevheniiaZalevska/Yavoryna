...
export const GALLERY = [
  ...
  { src: `${BASE}gallery/07.jpg`, alt: "Готові вироби", tag: "Посилка", group: "reports" },
  ...
  { src: `${BASE}gallery/10.jpg`, alt: "Готові вироби", tag: "Фідбек", group: "reports" },
  { src: `${BASE}gallery/11.jpg`, alt: "Плетіння сітки", tag: "Сітки", group: "other" },
  { src: `${BASE}gallery/12.jpg`, alt: "Плетіння сітки — процес", tag: "Процес", group: "other" },
  { src: `${BASE}gallery/13.jpg`, alt: "Шапка", tag: "побут", group: "warm" },
  { src: `${BASE}gallery/14.jpg`, alt: "Подушки", tag: "Побут", group: "warm" },
  { src: `${BASE}gallery/15.jpg`, alt: "Шкарпетки", tag: "Побут", group: "warm" },
  { src: `${BASE}gallery/16.jpg`, alt: "Килимки", tag: "побут", group: "warm" },
];
