  ...
  return (
    <section className="section">
      <div className="container heroGrid">
        <div>
          <div className="badge">
            <MapPin size={14} /> Представництво у {REGION_LABEL} ГО "Всеукраїнське Об'єднання Українок "Яворина"
          </div>
        ...
        >
          ...
          <div className="cardPadLg grid2">
            ...
            <div className="cardInner">
              ...
              <p className="p mt8">
                Закликаємо допомогти працею. Якщо у вас є навіть пару вільних годин, приходьте допомогти яворинкам. І ми швидше віддамо замовлення захисникам .
              </p>
            </div>
          </div>
        </motion.div>
